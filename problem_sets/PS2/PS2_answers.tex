...
\begin{enumerate}
	...
	\lstinputlisting[language=R, firstline=5, lastline=15]{PS2_answers.R}
	...
	Now calculate the p-value (in \texttt{R}).\footnote{Remember frequency should be $>$ 5 for all cells, but let's calculate the p-value here anyway.}  What do you conclude if $\alpha = .1$?\\
		...
		\lstinputlisting[language=R, firstline=18, lastline=21]{PS2_answers.R}
	...
	\lstinputlisting[language=R, firstline=24, lastline=37]{PS2_answers.R} 
	...
	\begin{tabular}{l | c c c }
		...
		\\[-1.8ex] 
		\hline \\[-1.8ex]
		Upper class & .322 & -1.642 & 1.523 \\
		Lower class & -.322 & 1.642 & -1.523 \\
		\hline
	\end{tabular}
\end{table}
	...
	\lstinputlisting[language=R, firstline=40, lastline=40]{PS2_answers.R} 
...
\begin{enumerate}
	...
	\lstinputlisting[language=R, firstline=44, lastline=52]{PS2_answers.R}
	
	\vspace{6cm}
	\item [(b)] Run a bivariate regression to test this hypothesis in \texttt{R} (include your code!).
	
	\lstinputlisting[language=R, firstline=55, lastline=69]{PS2_answers.R}
	
	\vspace{6cm}
	\item [(c)] Interpret the coefficient estimate for reservation policy. 
	\lstinputlisting[language=R, firstline=73, lastline=73]{PS2_answers.R}
...
\begin{enumerate}
	...
	\lstinputlisting[language=R, firstline=78, lastline=80]{PS2_answers.R}
...
\newpage
	...
	Plot \texttt{lifespan} vs \texttt{thorax}. Does it look like there is a linear relationship? Provide the plot. What is the correlation coefficient between these two variables?
		\vspace{6cm} 
			...
			\lstinputlisting[language=R, firstline=83, lastline=84]{PS2_answers.R}	
	\includegraphics[scale=.75]{Lifespan vs Thorax}	
		
	\item
	Regress \texttt{lifespan} on \texttt{thorax}.  Interpret the slope of the fitted model.
			\vspace{6cm} 
			
\lstinputlisting[language=R, firstline=87, lastline=92]{PS2_answers.R}
	...
	\lstinputlisting[language=R, firstline=97, lastline=107]{PS2_answers.R}	
...
\newpage
	...
	\lstinputlisting[language=R, firstline=115, lastline=116]{PS2_answers.R}	
	...
	\lstinputlisting[language=R, firstline=120, lastline=133]{PS2_answers.R}	
	...
	\lstinputlisting[language=R, firstline=136, lastline=138]{PS2_answers.R}	
	\includegraphics[scale=.75]{Fit Plot}
