...
\vspace{.5cm}
\lstinputlisting[language=R, firstline=38, lastline=41]{PS5_answers.R}  
\vspace{.5cm}
...
\begin{enumerate}[(a)]
	 ...
	 \lstinputlisting[language=R, firstline=45, lastline=46]{PS5_answers.R} 
	 
 
	 \includepdf[pages={1}]{Residuals vs Fitted.pdf} 

	 
	\item Check the normality assumption with a Q-Q plot of the studentized residuals. \vspace{6cm} 
	
		 \lstinputlisting[language=R, firstline=50, lastline=51]{PS5_answers.R} 
	 
 
	 \includepdf[pages={1}]{QQ plot.pdf} 
	
	\item Check for large leverage points by plotting the $h$ values. \vspace{6cm} 
	
		 \lstinputlisting[language=R, firstline=55, lastline=59]{PS5_answers.R} 
	 
 
	 \includepdf[pages={1}]{Hat values plot.pdf} 
	
	\item Check for outliers by running an \texttt{outlierTest}. \vspace{6cm} 
	
		 \lstinputlisting[language=R, firstline=63, lastline=64]{PS5_answers.R} 
	 
	
	\item Check for influential points by creating a "Bubble plot" with the hat-values and studentized residuals.
	% \item N/A. 
	
		 \lstinputlisting[language=R, firstline=68, lastline=73]{PS5_answers.R} 
	 
 
	 \includepdf[pages={1}]{Bubble plot.pdf} 
